...
public class Config {
    ...
    public static Map<Integer, Field> getInitialBoard() {
        ...
        assignment.put(1, new FieldProperty(new PropertyDataField("Geschichte", FieldLabel.PROPERTY, 60, 10, 30, 90, 160, 250, 0)));
        assignment.put(3, new FieldProperty(new PropertyDataField("Geographie", FieldLabel.PROPERTY, 60, 20, 60, 180, 320, 450, 0)));
        assignment.put(5, new FieldProperty(new PropertyDataField("Theologie", FieldLabel.PROPERTY, 100, 30, 90, 270, 400, 550, 1)));
        assignment.put(6, new FieldProperty(new PropertyDataField("Geisteswissenschaften", FieldLabel.PROPERTY, 100, 30, 90, 270, 400, 550, 1)));
        assignment.put(8, new FieldProperty(new PropertyDataField("Psychologie", FieldLabel.PROPERTY, 120, 40, 100, 300, 450, 600, 1)));
        assignment.put(10, new FieldProperty(new PropertyDataField("Biologie", FieldLabel.PROPERTY, 140, 50, 150, 450, 625, 750, 2)));
        assignment.put(12, new FieldProperty(new PropertyDataField("Physik", FieldLabel.PROPERTY, 140, 50, 150, 450, 625, 750, 2)));
        assignment.put(13, new FieldProperty(new PropertyDataField("Chemie", FieldLabel.PROPERTY, 160, 60, 180, 500, 700, 900, 2)));
        assignment.put(14, new FieldProperty(new PropertyDataField("Umweltingenieurwissensschaften", FieldLabel.PROPERTY, 180, 70, 200, 550, 750, 950, 3)));
        assignment.put(15, new FieldProperty(new PropertyDataField("Bauingenieurwesen", FieldLabel.PROPERTY, 180, 70, 200, 550, 750, 950, 3)));
        assignment.put(17, new FieldProperty(new PropertyDataField("Architektur", FieldLabel.PROPERTY, 200, 80, 220, 600, 800, 1000, 3)));
        assignment.put(19, new FieldProperty(new PropertyDataField("Betriebswirtschaftslehre", FieldLabel.PROPERTY, 220, 90, 250, 700, 875, 1050, 4)));
        assignment.put(21, new FieldProperty(new PropertyDataField("Volkswirtschaftslehre", FieldLabel.PROPERTY, 220, 90, 250, 700, 875, 1050, 4)));
        assignment.put(22, new FieldProperty(new PropertyDataField("Wirtschaftsinformatik", FieldLabel.PROPERTY, 240, 100, 300, 750, 925, 1100, 4)));
        assignment.put(23, new FieldProperty(new PropertyDataField("Elektrotechnik", FieldLabel.PROPERTY, 260, 110, 330, 800, 975, 1150, 5)));
        assignment.put(24, new FieldProperty(new PropertyDataField("Maschienenbau", FieldLabel.PROPERTY, 260, 110, 330, 800, 975, 1150, 5)));
        assignment.put(26, new FieldProperty(new PropertyDataField("Informatik", FieldLabel.PROPERTY, 280, 120, 360, 850, 1025, 1200, 5)));
        assignment.put(28, new FieldProperty(new PropertyDataField("Veterinärmedizin", FieldLabel.PROPERTY, 300, 130, 390, 900, 1100, 1275, 6)));
        assignment.put(30, new FieldProperty(new PropertyDataField("Biomedizin", FieldLabel.PROPERTY, 300, 130, 390, 900, 1100, 1275, 6)));
        assignment.put(31, new FieldProperty(new PropertyDataField("Humanmedizin", FieldLabel.PROPERTY, 320, 150, 450, 1000, 1200, 1400, 6)));
        assignment.put(33, new FieldProperty(new PropertyDataField("Aviatik", FieldLabel.PROPERTY, 350, 175, 500, 1100, 1300, 1500, 7)));
        assignment.put(35, new FieldProperty(new PropertyDataField("Rechtswissenschaften", FieldLabel.PROPERTY, 400, 200, 600, 1400, 1700, 2000, 7)));
